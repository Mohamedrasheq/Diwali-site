    ...
    <div className="flex flex-col md:flex-row w-full min-h-[400px]">
      ...
      <div className="w-full md:w-1/2 bg-black p-4 md:p-8">
        ...
        <iframe
          ...
          src="https://www.youtube.com/embed/CWYKpwlVGso" // Use embed link for YouTube
      ...
      <div className="w-full md:w-1/2 bg-black text-white p-8 flex flex-col justify-center items-center text-center">
        <h2 className="text-3xl font-bold mb-4">Celebrate Deepavali</h2>
        <p className="mb-6">
        ...
        <button className="bg-yellow-500 text-black font-bold py-2 px-4 rounded hover:bg-yellow-600 transition-colors duration-300">
          Buy Now
        </button>
      </div>
    </div>
